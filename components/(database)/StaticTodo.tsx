                        ...
                        >
                            {todos.map((item, index) => (
                                <li
                                    ...
                                    className={`px-2 py-2 rounded transition-all flex text-md ${item.focused ? 'bg-indigo-800' : ''
                                        } ${item.open
                                ...
                                >
                                    ...
                                    <div className="flex-grow max-w-full">
                                        <div className="w-full leading-none">
                                            <h3
                                                className={`text-md leading-none truncate w-full pr-10 ${item.title.length ? 'text-gray-300' : 'text-gray-500'
                                                    }`}
