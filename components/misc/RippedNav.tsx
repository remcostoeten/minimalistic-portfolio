...
export default function RippedNav() {
    ...
    return (
        ...
        <>
            ...
            >
                <div className="style-1" aria-label="Navigation">
                    <div className="style-2" aria-label="Logo & Links">
                        <div className="style-3" aria-label="Logo">
                            <div className="style-4" aria-label="Logo">
                                <div className="style-5">

                                    <div className="style-6" tabIndex={0}>
                                        <a
                                            className="style-7"
                                            data-highlight="true"
                                            href="./"
                                            ...
                                            aria-label="Large"
                                        >
                                            <div className="!bg-[#E5E5E5] style-8" aria-label="Button">
                                                <div className="style-9">
                                                    <div className="style-10">
                                                        <svg
                                                            ...
                                                            viewBox="0 0 256 256"
                                                            focusable="false"
                                                            color='var(--token-a5634a3e-d7fd-42f9-9a88-14274d3a57cf, rgb(245, 245, 245)) /* {"name":"text-invert"} */'
                                                            className="style-11"
                                                        >
                                                            <g
                                                                color='var(--token-a5634a3e-d7fd-42f9-9a88-14274d3a57cf, rgb(245, 245, 245)) /* {"name":"text-invert"} */'
                        ...
                        <div className="style-14" aria-label="Links">
                            <div
                                className="style-15"
                    ...
                    <div className="style-38" aria-label="Social Links & Buttons">
                            ...
                            <div className="style-48">
                                <div className="style-49" tabIndex={0}>
                                    <a
                                        ...
                                        tabIndex={0}
                                    >
                                        <div className="!bg-[#262626]  style-51" aria-label="Button">
                            ...
                            <div className="style-57">
                                <div className="style-58" tabIndex={0}>
                                    <a
                                        ...
                                        tabIndex={0}
                                    >
                                        <div className="!bg-[#262626] style-60" aria-label="Button">
                        ...
                        <div className=" style-66" aria-label="Buttons">
