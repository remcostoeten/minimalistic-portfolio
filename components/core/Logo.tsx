    ...
    <>
      <svg
        ...
        <path
          ...
          pathLength="1"
          style={{
            WebkitTransformOrigin: 27.6325,
            transformOrigin: 27.6325,
          }}
        ></path>
        <path
          fill="#000"
        ...
        {/* <path
          ...
          pathLength="1"
          style={{
            WebkitTransformOrigin: 45.3,
            transformOrigin: 45.3,
          }}
        ></path>
        <path
          fill="#fff"
          ...
          pathLength="1"
          style={{
            WebkitTransformOrigin: 56.1,
            transformOrigin: 56.1,
          }}
        ></path>
        <path
          fill="#fff"
          ...
          pathLength="1"
          style={{
            WebkitTransformOrigin: 74.9,
            transformOrigin: 74.9,
          }}
        ></path>
        <path
          fill="#fff"
          ...
          pathLength="1"
          style={{
            WebkitTransformOrigin: 93.1,
            transformOrigin: 93.1,
          }}
        ></path>
        <path
          fill="#fff"
