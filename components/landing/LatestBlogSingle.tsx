            ...
            <div className='flex gap-4 flex-col'>
                <SectionTitle><motion.span
                    ...
                    initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{
                        duration: fadeInDelays100[20] - 3,
                    }}
                >Some articles</motion.span> </SectionTitle>
                <div className='blog-preview  '>
                    {blogPosts.map((post, index) => (
                        <motion.div
                            initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[8] + index * 0.1 - 3 }}
                            key={index}
                            ...
                            <div className="geist flex gap-1 justify-between items-center text-sm">
                                <motion.span initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[13] - 3 }} className='flex gap-2'>
                                ...
                                <motion.div
                                    initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[14] - 3 }}
                            ...
                            <motion.span initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[16] }}>
                            ...
                            <div className="flex justify-between items-start py-2 px-2">
                                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[17] }}>
                                ...
                                <motion.div className="ml-4" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: fadeInDelays100[6] - 3, delay: fadeInDelays100[18] }}>
