...
const GridItem = ({ children }: blockProps) => (
    <div className="bg-grid flex h-[161px] flex-col grow shrink-0 basis-auto flex-1 rounded-16 justify-center items-center gap-y-4">
        {children}
    </div>
);
            ...
            <section className="flex max-md:flex-col gap-l max-md:items-stretch">
                ...
                <div className="flex flex-col items-stretch w-[67%] max-md:w-full">
                    <div className="flex gap-l grow flex-col w-[741px] max-md:max-w-full">
                        ...
                        <div className="border bg-neutral-200 self-stretch flex w-full flex-col-reverse rounded-16 border-solid border-white border-opacity-0 max-md:max-w-fullC h-full" />
                    </div>
                </div>
            </section>
        </div>
