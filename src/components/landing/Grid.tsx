...
const GridItem = ({ children }: ChildProps) => (
  <m.div
    ...
    transition={{ duration: fadeInDelays100[6], delay: fadeInDelays100[4] }}
    className=" grid--card perspective dark:grid--card dark:border-dark dark:text-white flex h-[161px] flex-col grow shrink-0 basis-auto flex-1 rounded-16 justify-center items-center gap-y-4"
  >
    {children}
  </m.div>
)
                        ...
                        <Tooltip>
                          <TooltipContent>
                            <span className="!text-black">
                              I have no idea what to put here. UI is hard, man
                            </span>
                          </TooltipContent>
                          <TooltipTrigger>
                            <Paragraph>
                              You can purcashe this spot for only €100,- per
                              month.
                            </Paragraph>
                          </TooltipTrigger>
                        </Tooltip>
