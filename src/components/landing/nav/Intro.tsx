  ...
  return (
    <div className="pt-[40px] contained flex flex-col gap-[64px]">
      <m.div
        ...
        initial="hidden"
        animate="show"
        className=" flex justify-between  flex-col gap-2 text-center "
      >
        <m.div
        ...
        >
          <m.div variants={menuItemAnimation} className="flex flex-col gap-4">
            ...
            >
              <div className="flex gap-1 items-center relative">
                ...
                <Sprinkle
                  className="text-4xl font-medium text-gray-100 block box-border leading-6 m-0 p-0 text-left no-underline break-words antialiased geist"
                  t1="Remco "
                  t2=""
                />
              </div>
          ...
          >
            <span
              className="wave absolute -right-10 -top-2 scale-[].5]"
              style={{ fontSize: "50px" }}
            >
              👋
            </span>
