...
export default function PinkCursor({ w = 23, h = 45 }: PinkCursorProps) {
    return (<svg className='z-[999]' width={w} height={h} viewBox='0 0 48 55' fill='none' style={{
        ...
        <g filter='url(#filter0_d_2_682)'>
            ...
            <path d='M6.76308 4.70864L3.89868 3.01601L4.527 6.28328L12.027 45.2832L12.7679 49.1358L14.7863 45.7716L23.4762 31.2885L39.3948 26.9472L42.8178 26.0136L39.7632 24.2085L6.76308 4.70864Z' stroke='white' strokeLinecap='square' />
        </g>
        <defs>
