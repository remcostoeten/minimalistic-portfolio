...
const CtaGhost = ({ children }: ChildProps) => {
  return (
    <button className="cssbuttons-io flex justify-center items-center text-center w-full bg-none border">
      <span>
...
const GhostButton = ({ children, onClick, className, size }: ChildProps) => {
  ...
  return (
    ...
    >
      <div className="outline-none flex flex-col justify-start flex-shrink-0 text-black transform-none opacity-100 relative flex-none h-auto overflow-visible whitespace-pre w-auto box-border antialiased">
        <p className="text-white font-semibold leading-6 text-start m-0 p-0 box-border antialiased hover:text-gray-300">
          {children}
        </p>
      </div>
    </m.button>
