...
export const ProjectData = [
    ...
    },
    {
        ...
        description: "My first (post jquery) react creation (without tutorial 😉). Basic kanban board authenticated with Firebase and same goes for the NoSQL database. Create tasks, edit, complete and allows for drag and drop between lanes.",
